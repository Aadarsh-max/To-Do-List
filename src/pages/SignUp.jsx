  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="absolute bottom-1/3 right-1/4 animate-float-slow">
        <UserPlus className="w-8 h-8 text-purple-300 opacity-20" />
      </div>

      <div className="relative z-10 bg-white/90 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-gray-100 w-full max-w-md transform transition-all hover:shadow-3xl my-8">
        ...
        <div className="space-y-4">
          <div className="group">
            ...
            <input
              ...
              disabled={loading}
              className="w-full bg-white text-black border-2 border-gray-200 px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 group-hover:border-gray-300"
          ...
          <div className="group">
            ...
            <input
              ...
              onChange={handleChange}
              disabled={loading}
              className="w-full text-black bg-white border-2 border-gray-200 px-4 py-3 rounded-xl outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 group-hover:border-gray-300"
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] mt-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
